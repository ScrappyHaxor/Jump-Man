...
namespace JumpMan.Objects
{
    class invisibleplatform : Entity
    {
        ...
        public invisibleplatform(string texture, ScrapVector position, ScrapVector dimensions) : base(SceneManager.CurrentScene.Stack.Fetch(DefaultLayers.FOREGROUND))
        {
